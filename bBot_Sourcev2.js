        ...
        switch(adv.media.format) {
            case 1:
                ...
                */
                ...
                if (data.timeDiff > 3) {
                    // avise que o vídeo no plug tem duração inferior à original e não será reproduzido na íntegra.
              ...
              /*
              {
                ...
                */
                if (data.apiBlocked) {
                    ...
                    return API.sendChat("/me [mediacheck] @staffs, a música atual possui bloqueio de API! uma analise é nescessária.");
                }
                ...
                if (data.timeDiff > 3) {
                    // avise que o áudio no plug tem duração inferior à original e não será reproduzido na íntegra.
                    API.sendChat("/me [mediacheck] @" + adv.dj.username + ", Este video possui duração inferior a original e por isso não será tocado na íntegra.");
                    return;
                } else if (data.timeDiff < -3) {
...
(function() {
    ...
    var loadChat = function(cb) {
        if (!cb) cb = function() {};
        $.get("https://rawgit.com/NiceATC/AnimeMusicMusicBR/master/botlang.json", function(json) {
    ...
    var botDollyMarsID = [13676638];

    var basicBot = {
        version: "4.9 (24/03/18) VERSÃO DE SEGURANÇA!!!",
        status: false,
        name: "World Bot",
        loggedInID: null,
        scriptLink: "https://worldofpop.tk/bot/bBot.js",
        cmdLink: "https://worldofpop.tk/#Commands",
        chatLink: "https://api.myjson.com/bins/1157h5.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            welcome: true,
            opLink: null,
            rulesLink: "https://worldofpop.tk/#Regras",
            themeLink: null,
            fbLink: "http://goo.gl/8iFw1s",
            youtubeLink: null,
            website: "https://worldofpop.tk",
            intervalMessages: [],
        ...
        userUtilities: {
            ...
            getPermission: function(obj) {
                ...
                if ((u.gRole || 0) < 3000) return u.role;
                else {
                    switch (u.gRole) {
                        case 3000:
        ...
        eventUserjoin: function(user) {
            ...
            if (botCreatorIDs.indexOf(user.id) > -1) {
                console.log(true);
                API.sendChat('Quem for diabético saia, porque o docinho @'+ user.username + ''+'chegou :yum:');
        ...
        chatUtilities: {
            chatFilter: function(chat) {
                ...
                if ((msg.indexOf("Use !entrar para participar!") > -1 || msg.indexOf("Thor lanÃ§a um raio e te joga pro fim da fila!") > -1 || msg.indexOf("vocÃª venceu e serÃ¡ movido para a posiÃ§Ã£o") > -1 || msg.indexOf("vocÃª Ã© digno do martelo") > -1 || msg.indexOf("vocÃª pode tentar levantar o martelo em") > -1 || msg.indexOf("Entre na fila e tente novamente!") > -1 || msg.indexOf("vocÃª perdeu e tem ainda") > -1 || msg.indexOf("vocÃª atingiu o limite e sÃ³ poderÃ¡ usar esta funÃ§Ã£o novamente em") > -1 || msg.indexOf("seu ultimo slot nÃ£o deu match e suas chances esgotaram!") > -1 || msg.indexOf("vocÃª sÃ³ pode usar este comando quando nÃ£o for o DJ.") > -1 || msg.indexOf("se vocÃª nÃ£o fala nada, muito menos o bot") > -1 || msg.indexOf("MUTE do Duel alterado para:") > -1 || msg.indexOf("te chamou pro fight, caso queira aceitar digite") > -1 || msg.indexOf("demorou para responder, provavelmente estÃ¡ com medo.") > -1 || msg.indexOf("aceitou o duelo! O resultado do confronto sai em instantes") > -1 || msg.indexOf("arregou e nÃ£o aceitou o duelo!") > -1 || msg.indexOf("ganhou a luta!") > -1 || msg.indexOf("todos os perdedores mutados foram agora desmutados.") > -1) && chat.uid === basicBot.loggedInID) {
                    setTimeout(function(id) {
            ...
            spam: [
                ...
                'lulz', 'huehue', 'hue', 'huehuehue', 'pula', 'ilha', 'Ã© biscoito', 'otaco',
        ...
        startup: function() {
            ...
            API.chatLog('OlÃ¡ ' + API.getUser().username + ', seja bem vindo Ã  minha nova interface traduzida! AgradeÃ§a ao V1RTU4L e ao MacacoPregoRoxo por isso. ');
            API.chatLog('AliÃ¡s, ja deu uma olhada na minha lista de comandos? Se nÃ£o, clique aqui: https://goo.gl/WQ6iwo ');
            //socket();
        ...
        commands: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    $.ajax({
                        ...
                        .done(function(data) {
                            ...
                            API.sendChat(subChat(basicBot.chat.cbResponse, {
                                name: chat.un,
                                message: resp.replace(/<\/?[^>]+(>|$)/g, "")
                            }));
                        })
                ...
                functionality: function(chat, cmd) {
                    ...
                    $.ajax({
                        ...
                        .done(function(data) {
                            ...
                            API.sendChat(subChat(basicBot.chat.elResponse, {
                                name: chat.un,
                                message: resp.replace(/<\/?[^>]+(>|$)/g, "")
                            }));
                        })
                ...
                functionality: function(chat, cmd) {
                    ...
                    $.ajax({
                        ...
                        .done(function(data) {
                            ...
                            API.sendChat(subChat(basicBot.chat.adsResponse, {
                                name: chat.un,
                                message: resp.replace(/<\/?[^>]+(>|$)/g, "")
                            }));
                        })
                ...
                functionality: function(chat, cmd) {
                    ...
                    $.ajax({
                        ...
                        .done(function(data) {
                            ...
                            API.sendChat(subChat(basicBot.chat.dicResponse, {
                                name: chat.un,
                                message: resp.replace(/<\/?[^>]+(>|$)/g, "")
                            }));
                        })
                ...
                functionality: function(chat, cmd) {
                    ...
                    $.ajax({
                        ...
                        .done(function(data) {
                            ...
                            API.sendChat(subChat(basicBot.chat.sinResponse, {
                                name: chat.un,
                                message: resp.replace(/<\/?[^>]+(>|$)/g, "")
                            }));
                        })
                ...
                functionality: function(chat, cmd) {
                    ...
                    $.ajax({
                        ...
                        .done(function(data) {
                            ...
                            API.sendChat(subChat(basicBot.chat.urlResponse, {
                                name: chat.un,
                                message: resp.replace(/<\/?[^>]+(>|$)/g, "")
                            }));
                        })
            ...
            fightCommand: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void(0);
                            ...
                            if (space === -1) {
                                ...
                                if (!ismuted) {
                                    if (user === false || !user.inRoom) {
                                        ...
                                        return API.sendChat("/me @" + chat.un + " não entendo o motivo de você querer lutar contra sí mesmo(a), você é uma pessoa tãoo lindo(a). :confused:");
                                    } else {
                                        API.sendChat("/me @" + user.username + ", @" + chat.un + " te chamou pro fight, caso queira aceitar digite !aceito, do contrário digite !rejeito. O perdedor serÃ¡ mutado por " + basicBot.settings.duelTime + " minutos.");
                        ...
                        } else API.sendChat("/me @" + chat.un + " jÃ¡ estÃ¡ havendo um duelo, espere este acabar!");
                    }
                }
            },
                        ...
                        if (basicBot.room.duel.users[0] != chat.uid) {
                            for (var i in basicBot.room.duel.users) {
                                if (chat.uid == basicBot.room.duel.users[i]) {
                                    ...
                                    var from = basicBot.room.duel.users[i - 1];
                                    var user = basicBot.userUtilities.lookupUser(from);
                                    API.sendChat("/me @" + user.username + ", @" + chat.un + " arregou e nÃ£o aceitou o duelo!");
                                    basicBot.room.duel.users = [];
                                    basicBot.room.duel.stats = false;
                                }
                            }
            ...
            autowootCommand: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void(0);
                        ...
                        API.sendChat("Para AutoWoot recomendamos o PlugPlus http://pplus.marsencrypt.tk/");
                    }
                }
            },
            ...
            temaCommand: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void(0);
                        ...
                        var msg = chat.message;
                        if (msg.length <= cmd.length + 1) return API.sendChat(subChat(basicBot.chat.currenttema, {
                            tema: basicBot.settings.tema
                        }));
                        var argument = msg.substring(cmd.length + 1);
                        if (argument) {
                            basicBot.settings.tema = argument;
                            API.sendChat(subChat(basicBot.chat.temaset, {
                                tema: basicBot.settings.tema
                            }));
                        }
                    }
            ...
            */
            ...
            customCommand: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void(0);
                        ...
                        API.sendChat('Fomulário de customização: https://worldofpop.tk/form');
                    }
                }
            },
            ...
            ghostbusterCommand: {
                command: ['ghostbuster', 'caÃ§afantasmas'],
                rank: 'user',
                type: 'startsWith',
                functionality: function(chat, cmd) {
                    if (this.type === 'exact' && chat.message.length !== cmd.length) return void(0);
...
*/
            ...
            jokenpoCommand: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void(0);
                        ...
                        var randomSentence = Math.floor(Math.random() * 1);
                        API.sendChat(subChat(basicBot.chat.jokenpo, {
                            name: chat.un,
                            botname: basicBot.settings.botName,
                            question: argument,
                            response: basicBot.chat.jokenpobot[randomBall]
                        }));
                    }
                }
            },
            ...
            frouletteCommand: {
                command: ['forceroleta', 'forÃ§arroleta'],
                rank: 'cohost',
                type: 'exact',
                functionality: function(chat, cmd) {
                    if (this.type === 'exact' && chat.message.length !== cmd.length) return void(0);
...
*/
            ...
            voteratioCommand: {
                command: ['voteratio', 'relaÃ§Ã£odevotos'],
                rank: 'bouncer',
                type: 'startsWith',
                functionality: function(chat, cmd) {
                    if (this.type === 'exact' && chat.message.length !== cmd.length) return void(0);
            ...
            debugonCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!bot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.moderateSetRole(3926149, 2000); 
                    }
                }
            },
    ...
    $.getScript('https://worldofpop.tk/bot/IA.js');
}).call(this);
